...
var es6_array_for_each = __webpack_require__(37);

// EXTERNAL MODULE: ../node_modules/core-js/modules/es6.array.iterator.js
var es6_array_iterator = __webpack_require__(49);

// EXTERNAL MODULE: ../node_modules/core-js/modules/es6.object.keys.js
var es6_object_keys = __webpack_require__(68);

// EXTERNAL MODULE: ../node_modules/core-js/modules/es6.object.define-property.js
var es6_object_define_property = __webpack_require__(34);

// EXTERNAL MODULE: ../node_modules/core-js/modules/es7.symbol.async-iterator.js
var es7_symbol_async_iterator = __webpack_require__(33);

// EXTERNAL MODULE: ../node_modules/core-js/modules/es6.symbol.js
var es6_symbol = __webpack_require__(30);

// EXTERNAL MODULE: ../node_modules/core-js/modules/es6.array.filter.js
var es6_array_filter = __webpack_require__(62);

// EXTERNAL MODULE: ../node_modules/core-js/modules/es6.function.bind.js
var es6_function_bind = __webpack_require__(61);

// EXTERNAL MODULE: ../node_modules/core-js/modules/es6.array.index-of.js
var es6_array_index_of = __webpack_require__(58);
...
var getElement = function getElement(element) {
  // case of HTMLElement
  var _element = element; // case of selector
  ...
  if (isElement(_element)) {
    ...
    throw "element: ".concat(element, " is not exists");
  }
};
var STYLE_SHEET = ".tl-card-container {\n    border: rgba(200,200,200,0.5) solid 1px;\n    border-radius: 10px;\n    overflow: hidden;\n    position: relative;\n    transition: box-shadow 0.4s ease;\n  }\n\n  .tl-card-bg-container {\n    border-radius: 10px;\n    overflow: hidden;\n    position: relative;\n  } \n\n  .tl-card-contents {\n    overflow: hidden;\n    position: relative;\n    border-radius: 10px;\n  }";
var COLOR = {
...
var getOriginSize = function getOriginSize(bgUrl) {
...
var getPixelSize = function getPixelSize(bgElement, url, size, getOriginSize) {
  var bgUrl = bgElement.style.backgroundImage,
...
// CONCATENATED MODULE: ../src/styler.js
...
function () {
   ...
   */
  function Styler(element, shadow, cardColor) {
    _classCallCheck(this, Styler);

    var contentsContainer = element.querySelector('.tl-card-contents-container'),
  ...
  _createClass(Styler, [{
    key: "setChildrenSize",
    value: function setChildrenSize(element) {
      ...
      try {
        for (var _iterator = children[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          ...
          child.style.height = "".concat(h, "px");
          child.style.width = "".concat(w, "px");
        }
      } catch (err) {
    ...
    key: "setShadow",
    value: function setShadow(element, shadow) {
      if (shadow) {
    ...
    key: "setCardColor",
    value: function setCardColor(element, cardColor) {
      switch (cardColor) {
        case 'clear':
    ...
    key: "setAlign",
    value: function setAlign(element, baseElement) {
      element.style.top = "-".concat(baseElement.clientHeight, "px");
    ...
    key: "cardBgInit",
    value: function cardBgInit(element, bgElement, cardBgStyle, filterValue, alignCallback) {
      var style = window.getComputedStyle(bgElement, null),
          img = style['backgroundImage'],
          repeat = style['backgroundRepeat'],
          size = style['backgroundSize'],
          cardHeight = element.clientHeight,
          cardWidth = element.clientWidth;
      cardBgStyle.cssText = "background-image: ".concat(img, ";\n      background-repeat: ").concat(repeat, ";\n      filter: blur(").concat(filterValue, "px);\n      margin-left: -").concat(filterValue, "px;\n      margin-top: -").concat(filterValue, "px;\n      height: ").concat(cardHeight + filterValue * 2, "px;\n      width: ").concat(cardWidth + filterValue * 2, "px;");
    ...
    key: "alignCardBackground",
    value: function alignCardBackground(element, bgElement, cardBgStyle, filterValue) {
      var style = window.getComputedStyle(bgElement, null),
      ...
      if (bgAttatchment === 'fixed') {
        ...
        cardBgStyle.backgroundPosition = bgOffset.left - (cardOffset.left - filterValue) + 'px ' + (bgOffset.top - (cardOffset.top - filterValue)) + 'px';
      }
    }
  }]);
...
// EXTERNAL MODULE: ../src/translucent.style.css
var translucent_style = __webpack_require__(55);

// CONCATENATED MODULE: ../src/translucent.js
...
function translucent_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function translucent_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function translucent_createClass(Constructor, protoProps, staticProps) { if (protoProps) translucent_defineProperties(Constructor.prototype, protoProps); if (staticProps) translucent_defineProperties(Constructor, staticProps); return Constructor; }
...
function () {
  ...
  function Translucent(element, options) {
    translucent_classCallCheck(this, Translucent);
    ...
    this.styler = new styler_Styler(this.element, this.options.shadow, this.options.cardColor);
    var bgInitCallback = this.styler.cardBgInit.bind(this, this.element, this.bgElement, this.cardBgStyle, this.options.filterValue, this.styler.alignCardBackground);
  ...
  translucent_createClass(Translucent, [{
    key: "_initStructure",
    value: function _initStructure(element) {
      // init contents
      ...
      cardContentContainer.appendChild(cardContent); // init background
    ...
    key: "_observeStyleChange",
    value: function _observeStyleChange() {
      var _this = this;

      var bgElementStyle = window.getComputedStyle(this.bgElement, null),
      ...
      this.styleObserver = new MutationObserver(function (mutations) {
        ...
        try {
          for (var _iterator = mutations[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            ...
            if (originOffset.top !== _this.element.offsetTop || originOffset.left !== _this.element.offsetLeft) {
              _this.styler.alignCardBackground(_this.element, _this.bgElement, _this.cardBgStyle, _this.options.filterValue);
            }

            var height = _this.element.clientHeight,
                width = _this.element.clientWidth;

            if (originHeight !== height || originWidth !== width || originImg !== bgElementStyle['backgroundImage'] || originFilter !== bgElementStyle['filter'] || originAttatchment !== bgElementStyle['backgroundAttachment']) {
              originWidth = width;
              originHeight = height;
              originImg = bgElementStyle['backgroundImage'];
              originFilter = bgElementStyle['filter'];

              _this.styler.cardBgInit(_this.element, _this.bgElement, _this.cardBgStyle, _this.options.filterValue, _this.styler.alignCardBackground);
            }
    ...
    key: "blur",
    value: function blur(filterValue) {
      this.options.filterValue = filterValue;
      this.styler.cardBgInit(this.element, this.bgElement, this.cardBgStyle, this.options.filterValue, this.styler.alignCardBackground);
    }
  }]);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Translucent", function() { return src_Translucent; });
...
function src_Translucent(element, options) {
  NodeList.prototype.forEach = Array.prototype.forEach;

  var _translucent = new translucent_Translucent(element, options);
...
// module
exports.push([module.i, ".tl-card-contents-container {\n  border: rgba(200,200,200,0.5) solid 1px;\n  border-radius: 10px;\n  overflow: hidden;\n  position: relative;\n  transition: box-shadow 0.4s ease;\n}\n\n.tl-card-bg-container {\n  border-radius: 10px;\n  overflow: hidden;\n  position: relative;\n} \n\n.tl-card-contents {\n  overflow: hidden;\n  position: relative;\n  border-radius: 10px;\n}", ""]);
...
$export($export.P, 'Function', { bind: __webpack_require__(60) });
